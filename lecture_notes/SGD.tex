...
\rm We can pick $\al=\dfrac{1}{2}$, for which we just need $\dfrac{1}{\gm \eta (1-2L\eta)m}=\dfrac{2L\eta}{1-2L\eta}=\dfrac{1}{4}$. The condition number for $\grad^2 P$ is $\kp=\dfrac{L}{\gm}$, and we set some integer $n$ so that $\kp = n$. Then we pick $\eta = \dfrac{0.1}{L}$ which gives 
