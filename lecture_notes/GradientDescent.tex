...
\item[(2)] Gauss-Southwell; 

\item[(3)] Stochastic coordinate descent; 

\item[(4)] Stochastic Gradient Methods; 

\item[(5)] Exact line search $\min\li_{\al>0}f(x^k+\al d^k)$; 

\item[(6)] Approximate Line Search, ``weak Wolfe conditions"; 

\item[(7)] Backtracking Line Search. 
\end{itemize}
